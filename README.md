...
https://d26rxx2euw6q9.cloudfront.net/


### ⚙️ Backend

**Render API Gateway:**  
https://agentverse-gateway.onrender.com

**Render Auth Service:**  
https://agentverse-auth.onrender.com

**Render Chat Service:**  
https://agentverse-chat.onrender.com

**Render Agent Service:**  
https://agentverse-agent.onrender.com

**Render Billing Service:**  
https://agentverse-billing.onrender.com
...
| ------------------ | --------------------- | ------------ |
| 🎨 Frontend        | AWS CloudFront        | 🟢 Live      |
| 🚪 API Gateway     | AWS ECS + ALB         | 🟢 Live      |
| 🔐 Auth Service    | AWS ECS               | 🟢 Live      |
| 💬 Chat Service    | AWS ECS               | 🟢 Live      |
| 🤖 Agent Service   | AWS ECS               | 🟢 Live      |
| 💳 Billing Service | AWS ECS               | 🟢 Live      |
| 🍃 MongoDB         | MongoDB Atlas         | 🟢 Connected |
| ⚡ Redis            | AWS ElastiCache Redis | 🟢 Connected |
...
Arpit-AgentVerse is deployed using a distributed **AWS cloud architecture**.
...
Production uses **AWS ElastiCache Redis**.
...
Arpit-AgentVerse is deployed using **AWS cloud infrastructure**.
...
The backend microservices are deployed independently using **AWS ECS** and exposed through an **Application Load Balancer (ALB)**.
